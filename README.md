...
## 🛠️ Tools & Workflow
* **SQL:** Engineered root-cause diagnostic queries (`streamflix_churn_analysis.sql`) to isolate conditional churn cliffs and segment high-risk cohorts.
* **Excel:** Initial data exploration, formatting, and validation of 5,000 customer records.
* **HTML/CSS/Vanilla JS:** Custom-coded a responsive, 3D-tilt executive dashboard from scratch using HTML Canvas API to visualize revenue risk without relying on out-of-the-box BI tools.
